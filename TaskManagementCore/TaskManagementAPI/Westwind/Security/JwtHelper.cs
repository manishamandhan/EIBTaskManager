...
namespace Westwind.AspNetCore.Security
{
    public class JwtHelper
    {
            ...
            Claim[] additionalClaims = null)
        {
            ...
            var key = new Microsoft.IdentityModel.Tokens.SymmetricSecurityKey(Encoding.UTF8.GetBytes(uniqueKey));
        ...
        /// <returns></returns>
        public static Microsoft.IdentityModel.Tokens.SymmetricSecurityKey GetSymetricSecurityKey(string issuerKey)
        {
            return new  Microsoft.IdentityModel.Tokens.SymmetricSecurityKey(Encoding.UTF8.GetBytes(issuerKey));
        }
    }
}
