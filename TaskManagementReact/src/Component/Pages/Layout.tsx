  ...
  return (
    <>
      <div className="d-flex ">
        ...
        <button className="d-lg-none " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" style={{ width: "40px", height: "40px", border: "none" }}>
        ...
        <div className="offcanvas-lg  offcanvas-start sidebar-offcanvas  canvas-width-set overflow-scroll-md " id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
          <div className="offcanvas-header bg-color">
            <h5 className="offcanvas-title img-logo-eib" id="offcanvasExampleLabel">
              <img src="assets/image/logo-inverse.png" alt="" />
            </h5>
            <button type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
          </div>
          <div className="offcanvas-body ">
            <ul className="text-start side-nav-items metismenu main-sidebar" id="sidebar_menu">
              {" "}
              <a className="img-logo-eib-1" href="/Dashboard">
              ...
              <li className="mb-2 list-unstyled">
                <a href="/Myprojects" className="sidebar-nav-links" title="Projects">
              ...
              <li className="mb-2 list-unstyled">
                <a href="/Reports" className="sidebar-nav-links" title="Reports">
              ...
              <li className="mb-2 list-unstyled">
                <a href="/Task" className="sidebar-nav-links" title="Tasks">
              ...
              <li className=" list-unstyled mb-2">
                ...
                <a onClick={handleLogout}>
                  <Button startIcon={<LogoutIcon />} className="main-btn mr-5 ">
                    Log Out
                  </Button>
                </a>
              </li>
        ...
        <div className="w-100 bg-main">
                  ...
                  <li className="nav-item">
                    <a className="nav-link me-2" aria-current="page" href="/">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="23" height="23">
                        <path d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" fill="#cdcdcd" />
                      </svg>{" "}
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link me-2  " title="Log Out" aria-current="page" onClick={handleLogout}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="25" height="25">
                        <path d="M399 384.2C376.9 345.8 335.4 320 288 320H224c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z" fill="#cdcdcd" />
                      </svg>
                    </a>
                  </li>
                </ul>
          ...
          <Box className="layout-padding m-4 p-3">
